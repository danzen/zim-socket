...
import {zimSocket2URL} from "https://zimjs.org/cdn/zimserver_urls_module"; // needs to be from ZIM server
zim.zimSocketURL = zimSocket2URL;

var WW = window||{};

if (!WW.zns) WW.zimSocketURL = zim.zimSocketURL;
...
export const Socket = zim.Socket;
export const zimSocketURL = zim.zimSocketURL;
